...
MySceneGraph.prototype.parseInitials= function(rootElement) {
	...
	if (elems.length == 0) {
		console.log("Warning: initial tag is missing!"); 
	...
	if(elems.length == 0) {
		console.log("Warning: frustum tag is missing!");
		...
		if (isNaN(this.initialsInformation.frustum['near'])) {
			console.log("Warning: frustum near invalid. It must be a float."); 
			this.initialsInformation.frustum['near'] = 0.1;
		}
		if(isNaN(this.initialsInformation.frustum['far'])) {
			console.log("Warning: frustum far invalid. It must be a float.") ; 
			this.initialsInformation.frustum['far'] = 500;
		}
	}
	...
	if (elems.length == 0)  {
		console.log("Warning: translation tag is missing!");
		...
		if(isNaN(this.initialsInformation.translate['x'])) {
			console.log("Warning: value of the translation axis must be a float!"); 
			this.initialsInformation.translate['x'] = 0;
		}
	...
	if (elems.length == 0)  {
		...
		if(isNaN(this.initialsInformation.rotation[this.reader.getString(elems[0],'axis',true)])){
			console.log("Warning: value of the rotation in x axis must be a float!"); 
			this.initialsInformation.rotation['x'] = 0;
		} 
		if(isNaN(this.initialsInformation.rotation[this.reader.getString(elems[1],'axis',true)])) {
			console.log("Warning: value of the rotation in y axis must be a float!"); 
			this.initialsInformation.rotation['y'] = 0;
		} 
		if(isNaN(this.initialsInformation.rotation[this.reader.getString(elems[2],'axis',true)])) {
			console.log("Warning: value of the rotation in z axis must be a float!"); 
			this.initialsInformation.rotation['z'] = 0;
		} 
	...
	if (elems == undefined || elems.length == 0)  {
		console.log("Warning: scale tag is missing!");
		...
		if(isNaN(this.initialsInformation.scale["sx"])) {
			console.log("Warning: value of the scale in x axis must be a float!"); 
			this.initialsInformation.scale['sx'] = 1;
		} 
		if(isNaN(this.initialsInformation.scale["sy"])) {
			console.log("Warning: value of the scale in y axis must be a float!"); 
			this.initialsInformation.scale['sy'] = 1;
		}
		if(isNaN(this.initialsInformation.scale["sz"])) {
			console.log("Warning: value of the scale in z axis must be a float!"); 
			this.initialsInformation.scale['sz'] = 1;
		}	
	}
	...
	if (elems.length == 0)  {
		console.log("Warning: reference tag is missing!");
	}
	...
	if(isNaN(this.initialsInformation.reference)) {
		console.log("Warning: value of the reference axis must be a float!"); 
...
MySceneGraph.prototype.parseIllumination = function(rootElement) {
	...
	if(illuminations.length == 0) {
		console.log("Warning:  illumination tag is missing!");
	}
	else {
...
MySceneGraph.prototype.parseLights = function(rootElement) {
	...
	if(lights.length == 0) console.log("Warning: lights tag is missing!");
	else {
	var light = lights[0];
	
	var tempLight = light.getElementsByTagName("LIGHT");
	if(tempLight.length == 0) console.log("Warning: No lights found!");
...
MySceneGraph.prototype.parseTextures = function(rootElement) {
	...
	if(textures.length == 0) {
		console.log("Warning: textures tag is missing!");
	}
	else {
		var all_textures = textures[0];

		var tag_texture = all_textures.getElementsByTagName("TEXTURE");
		if (tag_texture.length == 0) console.log("Warning: No textures found!");
		...
		for(var i = 0 ; i < tag_texture.length ; i++) {
			...
			if (amplifactor == undefined || amplifactor.length == 0) {
				console.log("Warning: Amplification factor for texture missing!");	
...
MySceneGraph.prototype.parseMaterials = function(rootElement) {
	...
	if(materials.length == 0) {
		console.log("Materials tag is missing!");
	}
	else {
		var all_materials = materials[0];
	
		var material = all_materials.getElementsByTagName("MATERIAL");
		if (material.length == 0) console.log("Warning: No materials found!");
		else {
